export const ROUTES = {
  ...
  discountReport: "/dashboard/reports/discounts",
  ...
  createProcurementrequest:
    "/dashboard/procurement-page/create-procurement-request",
  ...
  createMobileReceipt:
    "/dashboard/sales-management/receipt/create-mobile-receipt",
  ...
  generateReport:
    "/dashboard/sales-management/receipt-allocation/generate-report",
  allocateReceipt:
    "/dashboard/sales-management/receipt-allocation/allocate-receipt",
  partiallyPaidReceipt:
    "/dashboard/sales-management/receipt-allocation/partially-paid-receipt",
  advancedPaidReceipt:
    "/dashboard/sales-management/receipt-allocation/advance-paid-receipt",
  filledPartiallyPaidReceipt:
    "/dashboard/sales-management/receipt-allocation/filled-partially-paid-receipt",
  filledAvancedPaidReceipt:
    "/dashboard/sales-management/receipt-allocation/filled-advance-paid-receipt",
  ...
  allPurchaseInvoice:
    "/dashboard/purchase/purchase-invoice/all-purchase-invoice",
  nonInventory:
    "/dashboard/purchase/non-inventory-invoice/non-inventory-invoice",
  viewPurchaseInvoice:
    "/dashboard/purchase/purchase-invoice/view-purchase-invoice",
  ...
  viewNoFinancialImplication:
    "/dashboard/purchase/purchase-invoice/view-existing-purchase-invoice",
  viewPurchaseReceipt:
    "/dashboard/purchase/purchase-invoice/view-purchase-receipt",
  allNonInventory:
    "/dashboard/purchase/non-inventory-invoice/all-non-inventory-invoice",
  viewNonInventory:
    "/dashboard/purchase/non-inventory-invoice/view-non-inventory-invoice",
  viewNonInventory2:
    "/dashboard/purchase/non-inventory-invoice/view-non-inventory-invoices",
  allPurchaseReturns: "/dashboard/purchase/purchase-return",
  viewPurchaseReturns:
    "/dashboard/purchase/purchase-return/view-purchase-return",
  ...
  multipleInvoice:
    "/dashboard/purchase/remittance-advice/create-multiple-invoice",
  ...
  allocateRemittance:
    "/dashboard/purchase/remittance-advice/allocate-remmittance",
  matchRemittance: "/dashboard/purchase/remittance-advice/match-remmittance",
  unallocatedRemittance:
    "/dashboard/purchase/remittance-advice/unallocated-remmittance",
  advancedPaymentRemittance:
    "/dashboard/purchase/remittance-advice/advanced-payment-remmittance",
  filledUnallocatedRemittance:
    "/dashboard/purchase/remittance-advice/filled-unallocated-remmittance",
  filledAdvancedPaymentRemittance:
    "/dashboard/purchase/remittance-advice/filled-advanced-payment-remmittance",
  ...
  previewPurchaseOrder:
    "/dashboard/purchase/purchase-order/preview-purchase-order",
  purchaseOrderHistory:
    "/dashboard/purchase/purchase-order/purchase-order-history",
  ...
  vendorpage: "/dashboard/vendorPage",
  history: "/dashboard/subscriptionHistory",
  subplan: "/dashboard/subscriptionPlan",
  changeplan: "/dashboard/changePlan",
auditTrail: "/dashboard/auditTrail",
viewTrail: "/dashboard/viewTrail",
};
