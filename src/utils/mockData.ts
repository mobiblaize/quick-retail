...
import greenboxes from "../../src/assets/images/greenboxes.png";
import redboxes from "../../src/assets/images/redboxes.png";
import blackboxes from "../../src/assets/images/blackboxes.png";
...
import orangeReturn from "../../src/assets/images/orangeReturn.png";
import blueReturn from "../../src/assets/images/blueReturn.png";
import inventory from "../../src/assets/images/inventory.png";
import halforange from "../../src/assets/images/halforange.png";
import halfblue from "../../src/assets/images/halfblue.png";
import orangehome from "../../src/assets/images/orangehome.png";
...
export const allProcurementData = [
  {
    id: "#10010989",
    timestamp: "12 June, 4:20 PM",
    customer: "John Doe",
...
export const assetAnalyticsData = [
  {
...
export const activeDepreciationTable = [
  {
    assetid: "#234567",
    assetName: "Laptop",
    cost: " 234,500",
    usefulLife: "5",
    annualDepreciation: "10,000",
    method: "sum of years",
    rate: "32",
    dateOfPurchase: "13 June 2024",
  },
...
export const allSalesCustomers = [
  {
    name: "Ayodeji Ogunbayo",
    date: "13 Jan, 2025",
    contact: "ayoboo@gmail.com",
...
export const allCustomersInvoices = [
  {
    name: "#123456778",
    date: "Total Items: 10",
    contact: "₦31,000",
...
export const salesInvoiceOverviewData = [
  {
...
export const receiptOverviewData = [
  {
    title: "Total Number of receipt issued",
    value: "10,000",
    icon: dollar,
    iconColor: "#099137",
    textColor: "#E4E7EC",
...
export const inStoreOverviewData = [
  {
    title: "Number of sales return",
    value: "408",
    icon: orangeReturn,
    iconColor: "#099137",
    textColor: "#000000",
...
export const instoreData = [
  {
    id: "#1237527",
    name: "Ayodeji Ogunbayo",
    date: "#1232323",
    store: "Ikeja City Mall",
    number: "08178658171",
...
export const creditNoteOverviewData = [
  {
    title: "Number of credit note",
    value: "408",
    icon: orangeReturn,
    iconColor: "#099137",
    textColor: "#000000",
...
export const allPurchaseOverviewData = [
  {
    title: "NO. of Purchase Invoice Created",
    value: "50",
    icon: dollar,
    iconColor: "#099137",
    textColor: "#E4E7EC",
  ...
  {
    title: "Purchase Invoice Total Value",
    value: "$500,0000",
    icon: orangeboxes,
    iconColor: "#DD900D",
    textColor: "#1D2739",
...
export const allPurchaseInvoiceHistory = [
  {
    name: "Grateful Erhis",
    id: "#1232323",
    date: "April 7, 2025",
...
export const allNonInventoryInvoice = [
  {
    name: "Electric Iron",
    id: "#1232323",
    date: "April 7, 2025",
    vendorName: "Grateful Erhis",
    contact: "ayoboo@gmail.com",
    number: "08178658171",
    totalAmount: "₦51,000",
    timeStamp: "13 Jun, 2024",
...
export const allPurchaseReturnOverviewData = [
  {
    title: "No. OF Purchase RETURN",
    value: "67",
    icon: dollar,
    iconColor: "#099137",
    textColor: "#E4E7EC",
  ...
  {
    title: "Purchase RETURN TOTAL VALUE",
    value: "$500,0000",
    icon: orangeboxes,
    iconColor: "#DD900D",
    textColor: "#1D2739",
...
export const allDebitNoteOverviewData = [
  {
    title: "No. OF Purchase RETURN",
    value: "67",
    icon: dollar,
...
export const allPurchaseReturnInvoice = [
  {
    name: "Victoria Paschal",
    id: "#1232323",
    date: "April 7, 2025",
    contact: "ayoboo@gmail.com",
    number: "08178658171",
...
export const allRemittance = [
  {
    name: "Victoria Paschal",
    id: "17817 Invoice no: 3180",
    date: "April 7, 2025",
    location: "Lagos, Nigeria",
    contact: "Victoria Benson",
    number: "08178658171",
    totalAmount: "₦51,000",
    timeStamp: "13 Jun, 2024",
    status: "Sent",
...
export const allPurchaseOrderHistory = [
  {
    name: "Grateful Erhis",
    id: "#1232323",
    date: "April 7, 2025",
...
export const vendorOverviewData = [
  {
    title: "PURCHAASE INVOICE TOTAL VALUE",
    value: "$500,0000",
    icon: orangeboxes,
    iconColor: "#099137",
    textColor: "#1D2739",
    ...
    percentageValue: 0.5,
    altText: "approve-sign",
    message1: "Amount Paid",
    message2: "Outstanding Amount",
    amount1: "10,000,000",
    amount2: "200,000,000",
    borderColor: "#98A2B3",
  },
...
export const storesOverviewData = [
  {
    title: "TOTAL STORES",
    value: "200",
    icon: inventory,
...
export const storesOverviewData2 = [
  {
    title: "TOTAL INVENTORY",
    value: "540",
    icon: orangehome,
...
export const allPaymentOverviewData = [
  {
    title: "Total transaction value",
    value: "$34",
    icon: dollar,
