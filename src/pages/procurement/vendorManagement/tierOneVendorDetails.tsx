...
import TierOneDetails from "../../../components/dashboard/procurement/vendorManagement/tierOneDetails";
...
const TierOneVendorDetails: React.FC = () => {
...
export default TierOneVendorDetails;
