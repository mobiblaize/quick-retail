...
import ViewExistingPurchaseInvoiceForm from "../../../../components/finacialManagement/purchase.tsx/purchaseInvoice/viewExistingPurchaseInvoice";
...
export default function NoFinancialPurchaseInvoicePage() {
  ...
  return (
    <PageContainer subHeaders={getSubHeaders()}>
      <ViewExistingPurchaseInvoiceForm/>
    </PageContainer>
  );
}
