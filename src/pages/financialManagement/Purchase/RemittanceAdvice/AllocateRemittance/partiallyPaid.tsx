...
const PartiallyPaidPage= () => {
  ...
  const handleClick = () => {
    navigate(ROUTES.advancedPaymentRemittance);
  };
...
<div>
 ...
 Allocate Remittance Advice
        ...
        List of Unallocated / Unpaid / Partially Remittance Advice(s)
        </Text>
        <Text fw={300} size="md" c="#1D2939" className="text-[#667085] cursor-pointer"  onClick={handleClick} >
        List of Unallocated / Unpaid / Advanced Payment  Remittance Advice(s)
        </Text>
        </div>
      </div>
    ...
    Allocate Remittance Advice
        ...
        <div className="flex gap-[3em] cursor-pointer">
        <Text fw={300} size="sm" c="#F56630" className="text-[#667085] bg-[#F1672226] py-2 px-2">
        List of Unallocated / Unpaid / Partially Remittance <br/> Advice(s)
        </Text>
        <Text fw={300} size="sm" c="#1D2939" className="text-[#667085] cursor-pointer"  onClick={handleClick} >
...
export default PartiallyPaidPage;
