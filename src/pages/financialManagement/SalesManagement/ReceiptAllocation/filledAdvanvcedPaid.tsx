...
import FilledAdvancedPaidTable from "../../../../components/finacialManagement/salesManagement/receiptAllocation/filledAdvancedPaid";
import AllocatedModal from "../../../../components/finacialManagement/salesManagement/receiptAllocation/allocateModal";
import { useState } from "react";

const FilledAdvancedPaidPage = () => {
  ...
  const handleClick = () => {
    navigate(ROUTES.partiallyPaidReceipt);
  };
...
<div>
  ...
  return (
    ...
    <PageContainer subHeaders={subHeaders}>
        <FilledAdvancedPaidTable/>
    </PageContainer>
    </>
  );
};

export default FilledAdvancedPaidPage;
