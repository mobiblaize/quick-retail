...
const EditProductForm = () => {
  ...
  useEffect(() => {
    if (!formData.image_path) {
      setServerImages([]);
    } else if (Array.isArray(formData.image_path)) {
  ...
  const handleUpdateSubmit = () => {
    ...
    const variationsPayload = preparedVariants.map((v) => {
      ...
      const uniqueSku = v.variationID
        ? v.sku
        : `${baseSku}-${Math.floor(Math.random() * 10000)}`;
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <FormInput
              ...
              onChange={(val: string) =>
                setFormData({
                  ...formData,
                  product: { ...formData.product, product_name: val },
                })
              }
            />
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <FormInput
              ...
              onChange={(val: string) =>
                setFormData({
                  ...formData,
                  product: { ...formData.product, short_description: val },
                })
              }
            />
          </Grid.Col>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <FormInput
              ...
              onChange={(val: string) =>
                setFormData({
                  ...formData,
                  product: { ...formData.product, tags: val },
                })
              }
            />
          </Grid.Col>
                ...
                {images.map((file, index) => (
                  ...
                  >
                    ...
                    <ActionIcon
                      ...
                      className="opacity-0 group-hover:opacity-100 transition-all duration-200 border-2 border-white shadow-lg"
                    >
