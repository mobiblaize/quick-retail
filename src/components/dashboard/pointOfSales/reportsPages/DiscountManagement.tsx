  ...
  return (
    ...
    <section className="w-full lg:flex-1 min-w-[320px] h-auto px-4 sm:px-6 py-6 sm:py-8 rounded-lg bg-white">
      ...
      <div className="mt-6 flex flex-col gap-4 overflow-x-auto">
        {/* Header */}
        <div className="flex justify-between items-center px-2 py-2 bg-gray-100 rounded font-medium text-sm text-black min-w-[320px]">
          ...
          <div className="flex gap-6 sm:gap-8 items-center justify-end text-right min-w-[200px]">
            ...
            <div className="min-w-[80px]">Redemptions</div>
          </div>
        </div>
        ...
        {topProducts.map((product, index) => (
          ...
          >
            ...
            <div className="flex gap-6 sm:gap-8 items-center justify-end text-right min-w-[200px]">
              <Text fw={400} size="sm" c="black" className="min-w-[80px] text-right">
