...
import { Text, Avatar, Badge, Paper } from "@mantine/core";
import { PaidDot, UnpaidDot } from "../../../../assets/svg";
import { Link } from "react-router";
import { ROUTES } from "../../../../constants/routes";
import { useFetchingleOrderProducts } from "../../../../hooks/backendApis/pos/salesProcessing";
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row: any) => {
        ...
        return (
          <Badge
            leftSection={status === "Active" ? <PaidDot /> : <UnpaidDot />}
    ...
    },
    {
      ...
      header: "",
      render: (row: any) => (
        <Link to={ROUTES.viewStoreProduct} state={{ variationID: row.variationID }}>
          <Text fw={600} c="blue" className="cursor-pointer">
            View
          </Text>
        </Link>
      ),
