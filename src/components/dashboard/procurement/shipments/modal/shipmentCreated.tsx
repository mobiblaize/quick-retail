...
export default function ShipmentCreatedModal({ opened, onClose }: Props) {
  return (
    <Modal
      opened={opened}
      onClose={onClose}
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-[#667085] text-[15px]">
          Shipment #1234567 has been successfully created.
        </p>
        ...
        >
          ...
          <Button variant="filled-primary" onClick={onClose}>Close</Button>
        </div>
      </div>
    </Modal>
  );
