...
export default function ActivateVendorModal({ opened, onClose }: Props) {
  return (
    <Modal
      opened={opened}
      onClose={onClose}
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-[#667085] text-[15px]">
          If activated you will be able to use the vendor on the platform again.
        </p>
        ...
        >
          ...
          <Button variant="filled-primary">Activate</Button>
        </div>
      </div>
    </Modal>
  );
