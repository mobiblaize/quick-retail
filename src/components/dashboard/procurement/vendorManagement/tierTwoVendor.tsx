...
import { tierTwoData } from "../../../../utils/mockData";
        ...
        tableTitle={
          <div className="flex gap-2.5">
            ...
            <div className="bg-[#FFEADF] rounded-full flex items-center py-0.5 px-3">
              <Text c="customPrimary.10">{tierTwoData.length}</Text>
            </div>
          </div>
        }
      />
