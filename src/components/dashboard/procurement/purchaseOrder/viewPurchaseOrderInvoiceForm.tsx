...
import SaveAndUpdateModal from "./modal/saveAndUpdateModal";

export default function ViewPurchaseOrderInvoiceForm() {
          ...
          <div className="bg-white p-6 rounded-md shadow-sm space-y-4">
            ...
            <div className="border border-gray-200 rounded-md px-3 py-2 flex items-center gap-3 w-full">
              ...
              <div className="flex gap-3">
                <button
                  className="text-[#5F6368] text-sm cursor-pointer"
                >
                  View
                </button>
                <button
