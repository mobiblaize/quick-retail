...
import { allApprovedRequest } from "../../../../utils/mockData";
...
const TotalApproveRequestTable = () => {
  const columns: ColumnDef<TableRowData>[] = [
        ...
        return (
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full font-medium text-sm ${
              status === "Success"
                ? "bg-[#ECFDF3] text-[#027A48]" // Green badge for Approved
                : ""
            }`}
          >
            <PaidDot /> 
    ...
    
    {
      ...
      accessorKey: "action",
      cell: () => (
        <Link to={ROUTES.viewApproveRequest}>
        ...
        tableTitle={
          <div className="flex gap-2.5">
            ...
            <div className="bg-[#FFEADF] rounded-full flex items-center py-0.5 px-3">
              <Text c="customPrimary.10">{allApprovedRequest.length}</Text>
            </div>
          </div>
        }
      />
...
export default TotalApproveRequestTable;
