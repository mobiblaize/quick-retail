...
import {  allNonInventoryInvoice, productTableData, } from "../../../../utils/mockData";
import { Link } from "react-router";
import { ROUTES } from "../../../../constants/routes";

const AllNonInventoryTable = () => {
  const columns: ColumnDef<TableRowData>[] = [
    ...
    
    {
        ...
        accessorKey: "action",
        cell: () => (
          <Link to={ROUTES.viewNonInventory}>
...
export default AllNonInventoryTable ;
