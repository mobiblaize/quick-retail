...
export default function MultipleRemmittanceCreate() {
...
navigate(ROUTES.attachRemittance)
  ...
  useEffect(() => {
    if (selectedType === "Multiple Invoice") {
      navigate(ROUTES.multipleInvoice);
    } else if (selectedType === "Single Purchase Invoice") {
        navigate(ROUTES.singleInvoice);
    }
