...
import IssueModal from "./issueDebitNote";
            ...
            <div className="flex flex-col">
              <div className="flex flex-row gap-8">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mt-[2em]">
                    ...
                    <div className="text-gray-800">
                      ...
                      <div className="mt-3">
                        ...
                        >
                          Total Outstanding ={" "}
                          <span className="text-[red]">₦31,000,000</span>
                        </Text>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col w-full lg:hidden">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mt-[2em]">
                    <h2 className="text-lg font-medium text-gray-800 mb-4 border-b border-gray-200 uppercase">
                    Purchase Return Value<span className="text-[red]"> *</span>
                    </h2>
