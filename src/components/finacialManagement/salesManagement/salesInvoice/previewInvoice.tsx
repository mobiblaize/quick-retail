      ...
      <div className="px-7 flex flex-col gap-4">
        <header className="w-full md:max-w-[45%]">
          ...
          <div className="flex flex-wrap mt-2 gap-5">
            ...
            <p>|</p>
            <Text fw={400} c="red" className="text-xl text-[red]">
            Due Date: <span className="ml-2 text-[red]">June 7, 2024</span>
            </Text>
          </div>
        </header>
        ...
        <div className="md:max-w-6xl w-full">
          ...
          <section>
            <div className="pt-8 pb-6">
              ...
              <div className="w-[100%] mx-auto flex justify-end gap-4 items-end pr-4 cursor-pointer bottom-0 right-0 ">
              <button
                className="bg-[white] cursor-pointer text-[#F16722] px-6 py-2 rounded-lg font-semibold hover:bg-orange-200 transition duration-300 border border-[#F16722]"
